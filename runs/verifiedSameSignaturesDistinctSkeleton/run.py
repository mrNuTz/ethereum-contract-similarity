...
plot.saveScatter(df_in, 'ppdeep', 'lzjd1', title='inScatter')
plot.saveScatter(df_in, 'ppdeep', 'size', title='inScatter')
plot.saveScatter(df_in, 'byteBagJaccard', 'lzjd1', title='inScatter')
plot.saveScatter(df_in, 'byteBagJaccard', 'size', title='inScatter')
plot.saveScatter(df_in, 'lzjd1', 'size', title='inScatter')
...
plot.saveScatter(df_out, 'ppdeep', 'lzjd1', title='outScatter')
plot.saveScatter(df_out, 'ppdeep', 'size', title='outScatter')
plot.saveScatter(df_out, 'byteBagJaccard', 'lzjd1', title='outScatter')
plot.saveScatter(df_out, 'byteBagJaccard', 'size', title='outScatter')
plot.saveScatter(df_out, 'lzjd1', 'size', title='outScatter')
...
plot.saveScatter(df_all, 'ppdeep', 'lzjd1', title='allScatter', colorBy='isIn')
plot.saveScatter(df_all, 'ppdeep', 'size', title='allScatter', colorBy='isIn')
plot.saveScatter(df_all, 'byteBagJaccard', 'lzjd1', title='allScatter', colorBy='isIn')
plot.saveScatter(df_all, 'byteBagJaccard', 'size', title='allScatter', colorBy='isIn')
plot.saveScatter(df_all, 'lzjd1', 'size', title='allScatter', colorBy='isIn')
